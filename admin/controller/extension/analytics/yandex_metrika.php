...
class ControllerExtensionAnalyticsYandexMetrika extends Controller {
	...
	public function index() {
		...
		}elseif (isset($setting_info["analytics_yandex_metrika_code"])) {
			$data['analytics_yandex_metrika_code'] = $setting_info["analytics_yandex_metrika_code"];
		} else {
		...
		}elseif (isset($setting_info["analytics_yandex_metrika_status"])) {
			$data['analytics_yandex_metrika_status'] = $setting_info["analytics_yandex_metrika_status"];
		} else {
		...
		if (isset($this->request->post['analytics_yandex_metrika_no_admin'])) {
			...
			$data['analytics_yandex_metrika_no_admin'] = '0';
		}
		...
		if (isset($this->request->post['analytics_yandex_metrika_no_users'])) {
			...
			$data['analytics_yandex_metrika_no_users'] = '0';
		}
