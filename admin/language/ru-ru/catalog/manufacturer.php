...
// Error
$_['error_permission']  = 'У Вас нет прав для изменения бренда!';
$_['error_name']        = 'Название бренда должно быть от 1 до 64 символов!';
$_['error_keyword']     = 'SEO URL занят!';
$_['error_unique']      = 'SEO URL должен быть уникальным!';
$_['error_product']     = 'Внимание: Данного бренда нельзя удалить так как назначен %s товарам!';
