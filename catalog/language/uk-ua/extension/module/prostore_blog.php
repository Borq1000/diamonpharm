...
$_['text_comment_add'] = 'Надіслати';
$_['text_comment'] = 'Залишити коментар';
$_['text_comment_name'] = 'Ім\'я';
$_['text_comment_text'] = 'Ваш коментар';
$_['text_loading'] = 'Завантаження...';
$_['text_error'] = 'Стаття не знайдена!';
$_['text_cat_error']  = 'Категорія не знайдена!';
